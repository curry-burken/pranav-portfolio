...
const Work = ({ isDesktop }) => {
  ...
  const tabItems = useMemo(
    () => [
      {
        title: "Novac Technology Solutions",
        value: "Novac Technology Solutions",
        content: (
          <StickyScroll
            isDesktop={isDesktop}
            contentItems={WORK_CONTENTS.NOVAC}
          />
        ),
      },
      {
        ...
        content: (
          <StickyScroll
            isDesktop={isDesktop}
            contentItems={WORK_CONTENTS.DATTAM}
          />
        ),
      },
      {
        ...
        content: (
          <StickyScroll
            isDesktop={isDesktop}
            contentItems={WORK_CONTENTS.DELOITTE}
          />
        ),
      },
      {
        title: "Systech Solutions",
        value: "Systech Solutions",
        content: (
          <StickyScroll
            isDesktop={isDesktop}
            contentItems={WORK_CONTENTS.SYSTECH}
          />
        ),
      },
      {
        title: "Ducont India Systems",
        value: "Ducont India Systems",
        content: (
          <StickyScroll
            isDesktop={isDesktop}
            contentItems={WORK_CONTENTS.DUCONT}
          />
        ),
      },
    ],
